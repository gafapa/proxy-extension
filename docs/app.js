const translations = {
  en: {
    ...
    heroLead: "Proxy forwards requests through a Chrome service worker so your frontend can reach blocked endpoints while usage stays limited to gallego.top, subdomains of gallego.top, and local development pages.",
  ...
  es: {
    ...
    heroLead: "Proxy reenvía solicitudes a través de un service worker de Chrome para que tu frontend pueda alcanzar endpoints bloqueados mientras el uso queda limitado a gallego.top, sus subdominios y páginas de desarrollo local.",
  ...
  gl: {
    ...
    heroLead: "Proxy reenvía solicitudes a través dun service worker de Chrome para que o teu frontend poida chegar a endpoints bloqueados mentres o uso queda limitado a gallego.top, aos seus subdominios e ás páxinas de desenvolvemento local.",
    heroPrimaryCta: "Descargar paquete",
    heroSecondaryCta: "Guía de instalación",
  ...
  fr: {
    ...
    heroLead: "Proxy transmet les requêtes via un service worker Chrome afin que votre frontend puisse atteindre des endpoints bloqués tout en limitant l'usage à gallego.top, à ses sous-domaines et aux pages de développement local.",
  ...
  de: {
    ...
    heroLead: "Proxy leitet Anfragen über einen Chrome-Service-Worker weiter, damit dein Frontend blockierte Endpunkte erreichen kann, während die Nutzung auf gallego.top, dessen Subdomains und lokale Entwicklungsseiten beschränkt bleibt.",
  ...
  pt: {
    ...
    heroLead: "Proxy encaminha pedidos através de um service worker do Chrome para que o teu frontend consiga alcançar endpoints bloqueados, mantendo o uso limitado a gallego.top, aos seus subdomínios e a páginas de desenvolvimento local.",
  ...
  ca: {
    ...
    heroLead: "Proxy reenvia sol·licituds a través d'un service worker de Chrome perquè el teu frontend pugui arribar a endpoints bloquejats mentre l'ús queda limitat a gallego.top, als seus subdominis i a pàgines de desenvolupament local.",
  ...
  eu: {
    ...
    heroLead: "Proxyek eskaerak Chrome service worker baten bidez birbidaltzen ditu zure frontendak blokeatutako endpointetara iritsi ahal izateko, erabilera gallego.top, haren azpidomeinu eta garapen lokaleko orrietara mugatuta mantenduz.",
