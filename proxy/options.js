...
const optionTranslations = {
  en: {
    ...
    maxBodyLabel: "Max request body size",
    unlimitedBody: "Unlimited",
    maxResponseLabel: "Max response body size",
  ...
  es: {
    ...
    maxBodyLabel: "Tamaño máximo de petición",
    unlimitedBody: "Sin límite",
    maxResponseLabel: "Tamaño máximo de respuesta",
  ...
  fr: {
    ...
    maxBodyLabel: "Taille maximale de requête",
    unlimitedBody: "Illimitée",
    maxResponseLabel: "Taille maximale de réponse",
  ...
  de: {
    ...
    maxBodyLabel: "Maximale Anfragegröße",
    unlimitedBody: "Unbegrenzt",
    maxResponseLabel: "Maximale Antwortgröße",
  ...
  pt: {
    ...
    maxBodyLabel: "Tamanho máximo do pedido",
    unlimitedBody: "Sem limite",
    maxResponseLabel: "Tamanho máximo da resposta",
    allowedMethodsLabel: "Métodos HTTP permitidos",
    saveButton: "Guardar",
    resetButton: "Repor",
  ...
  gl: {
    ...
    maxBodyLabel: "Tamaño máximo da petición",
    unlimitedBody: "Sen límite",
    maxResponseLabel: "Tamaño máximo da resposta",
    allowedMethodsLabel: "Métodos HTTP permitidos",
    saveButton: "Gardar",
  ...
  ca: {
    ...
    maxBodyLabel: "Mida màxima de petició",
    unlimitedBody: "Sense límit",
    maxResponseLabel: "Mida màxima de resposta",
  ...
  eu: {
    ...
    maxBodyLabel: "Eskaeraren gehieneko tamaina",
    unlimitedBody: "Mugarik gabe",
    maxResponseLabel: "Erantzunaren gehieneko tamaina",
...
function applyTranslations() {
  ...
  setText("unlimited-body-option", dictionary.unlimitedBody);
